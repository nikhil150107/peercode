        ...
        <div className="flex items-center gap-1.5 sm:gap-3">
          ...
          {role === "interviewer" && onSwapRoles && (
            <button
              type="button"
              onClick={onSwapRoles}
              className="rounded-lg bg-violet-500/15 px-2 py-1.5 text-xs font-semibold text-violet-300 ring-1 ring-violet-500/30 transition hover:bg-violet-500/25 sm:px-4 sm:py-2 sm:text-sm"
            >
              Swap
            </button>
          )}
          <button
            ...
            className="rounded-lg bg-red-500/15 px-2 py-1.5 text-xs font-semibold text-red-400 ring-1 ring-red-500/30 transition hover:bg-red-500/25 sm:px-4 sm:py-2 sm:text-sm"
          >
            End
          </button>
        </div>
