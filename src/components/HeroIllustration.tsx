...
export default function HeroIllustration() {
  return (
    <div className="relative mx-auto w-full max-w-lg" aria-hidden="true">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-stroke bg-surface-secondary/80 shadow-2xl shadow-black/40">
        <div className="flex items-center gap-2 border-b border-stroke bg-surface-secondary px-4 py-3">
        ...
        <div className="grid gap-0 sm:grid-cols-2">
          <div className="min-w-0 border-b border-stroke sm:border-b-0 sm:border-r">
            <div className="border-b border-stroke px-3 py-2 text-[10px] uppercase tracking-wider text-content-muted">
              Code editor
            </div>
            <pre
